...
//     @PostMapping("/trigger")
//     public ResponseEntity<ApiResponse<AssignmentResponse>> trigger(@Valid @RequestBody TriggerAssignmentRequest request) {
...
//     public ResponseEntity<ApiResponse<AssignmentResponse>> acknowledge(@Valid @RequestBody AcknowledgeRequest request) {
...
//     public ResponseEntity<ApiResponse<AssignmentResponse>> checkTimeout(@PathVariable Long ticketId) {
...
//     @GetMapping("/{ticketId}")
//     public ResponseEntity<ApiResponse<AssignmentResponse>> getAssignment(@PathVariable Long ticketId) {
...
//     public ResponseEntity<ApiResponse<List<AssignmentResponse>>> getByPerson(@PathVariable Long supportPersonId) {
