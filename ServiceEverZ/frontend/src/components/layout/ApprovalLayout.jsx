// FILE: src/components/layout/ApprovalLayout.jsx
// Shared layout for the unified /approvals and /resource-owner routes.
// Identical shell to LOneLayout — just renamed so routes are decoupled
// from the old L1/L2 layout files.
