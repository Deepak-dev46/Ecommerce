...
// // Sub-module 01 — Private Internal Notes (Work Notes)
// // Visible ONLY to support agents — never rendered in end-user pages.

// import React, { useState, useEffect, useRef } from 'react';
// import {
//   Box, Typography, TextField, Button, CircularProgress, Alert,
//   Paper, Divider, Chip, Avatar, Tooltip, Autocomplete
// } from '@mui/material';
// import LockIcon from '@mui/icons-material/Lock';
// import SendIcon from '@mui/icons-material/Send';
// import AlternateEmailIcon from '@mui/icons-material/AlternateEmail';
// import { getInternalNotes, addInternalNote, getMentionSuggestions } from '../../api/collaborationApi';
...
// export default function InternalNotesPanel({ ticketId }) {
...
//   const [mentionedAgents, setMentionedAgents] = useState([]); // {userId, fullName, email}
...
//   // ── @mention: fetch suggestions when user types @ ─────────────────────────
...
//     // Replace the @query text with @AgentName
...
//                 <Box sx={{ mt: 0.5 }}>
//                   <AlternateEmailIcon sx={{ fontSize: 13, color: '#1976d2', verticalAlign: 'middle' }} />
...
//           multiline
//           minRows={3}
//           placeholder="Add an internal note... Use @Name to mention a support agent"
//           value={content}
...
//                 }}
//               >
//                 <Avatar sx={{ width: 26, height: 26, fontSize: 12, bgcolor: '#1976d2' }}>
...
//           sx={{ backgroundColor: '#f9a825', color: '#333', '&:hover': { backgroundColor: '#f0a000' } }}
//         >
