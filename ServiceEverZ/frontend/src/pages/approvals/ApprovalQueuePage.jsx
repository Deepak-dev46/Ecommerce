...
//         ticketApi.getCommentsByChannel(a.ticketId, `${getApproverLevel(a)}_USER`).catch(() => []),
...
//                           String(a.l1ApproverId) === approverId
...
//           {modalLoading ? <Spinner /> : (
//             <>
//               {/* ── TAB BAR — only show if NEED_INFO was ever sent ── */}
...
//                     User replies to your information request appear below.
//                   </div>
